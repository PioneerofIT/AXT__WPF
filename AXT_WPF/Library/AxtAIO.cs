...
//========== Initilize/Close =========================================================================
    ...
    [DllImport("AxtLib.dll")] public static extern int AIOmulti_read_one_volt_adc(short nCHNum, short[] pnCHList, short nDataNum, double[,] pdVolt);
    [DllImport("AxtLib.dll")] public static extern int AIOmulti_read_one_digit_adc(short nCHNum, short[] pnCHList, short nDataNum, ushort[,] pwDigit);    
